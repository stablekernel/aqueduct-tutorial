...
///
/// Use instances of this class to start/stop the test heroes server. Use [client] to execute
/// requests against the test server.  This instance will use configuration values
/// from config.src.yaml.
class TestApplication {
  Application<HeroesChannel> application;
  HeroesChannel get channel => application.channel;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [HeroesChannel]. Invoke this method
  ...
  Future start() async {
    ...
    application = new Application<HeroesChannel>();
